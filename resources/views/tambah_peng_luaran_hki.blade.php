  ...
  <div class="row">
    <div class="col-md-10 col-md-offset-1">
      ...
      <div class="box box-primary">
        ...
        <form role="form" method="POST" action="{{secure_asset($menu['kategori'].'/tambah_peng_luaran_hki/'.$menu['data']->id)}}" enctype="multipart/form-data">
          @else
          <form role="form" method="POST" action="{{url($menu['kategori'].'/tambah_peng_luaran_hki/'.$menu['data']->id)}}" enctype="multipart/form-data">
            @endif
            {{csrf_field()}}
           ...
           <div class="box-body">
            <div class="row">
             ...
             <div class="form-group col-md-4" >
               ...
               <label for="select2 tahun">Tahun</label>
