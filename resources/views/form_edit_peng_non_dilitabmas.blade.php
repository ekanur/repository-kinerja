      ...
      <form role="form" method="POST" action="{{secure_asset($menu['kategori'].'/update_peng_non_dilitabmas/'.$menu['data']->id)}}" enctype="multipart/form-data">
        ...
        <form role="form" method="POST" action="{{url($menu['kategori'].'/update_peng_non_dilitabmas/'.$menu['data']->id)}}" enctype="multipart/form-data">
          ...
          <div class="box-body">
            ...
            <div class="form-group col-md-6" >
             <label for="jenis_pengabdian">Jenis Pengabdian</label>
             <select class="select2 form-control" name="isi_jenis_pengabdian" id="isi_jenis_pengabdian">
               <option value="{{$menu['data']->isi_jenis_pengabdian}}">{{$menu['data']->isi_jenis_pengabdian}}</option>   
           ...
           <div class="row">
             <div class="form-group col-md-4" >
              ...
              <input type="number" class="form-control" id="jumlah_mahasiswa" name="jumlah_mahasiswa" placeholder="Jumlah Mahasiswa" value="{{$menu['data']->jumlah_mahasiswa}}">
            </div>
            <div class="form-group col-md-4" >
            ...
            <div class="form-group col-md-4" >
              ...
              <input type="number" class="form-control" id="jumlah_staf" name="jumlah_staf" placeholder="Jumlah Staf" value="{{$menu['data']->jumlah_staf}}">
            </div>
          </div>
         ...
         <div class="row">
           <div class="form-group col-md-4" >
            ...
            <select class="select2 form-control" name="tahun_mulai" id="tahun_mulai">
             <option value="{{$menu['data']->tahun_mulai}}">{{$menu['data']->tahun_mulai}}</option>
        ...
        <div class="form-group col-md-4" >
          ...
          <select class="select2 form-control" name="tahun_selesai" id="tahun_selesai">
           <option value="{{$menu['data']->tahun_selesai}}">{{$menu['data']->tahun_selesai}}</option>
           <option value="">Pilih Tahun</option>
           <?php
           $thn_skr = date('Y');
           for ($x = $thn_skr; $x >=1954; $x--) {
