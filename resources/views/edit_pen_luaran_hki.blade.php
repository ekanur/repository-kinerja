   ...
   <div class="col-md-10 col-md-offset-1">
    ...
    <div class="box box-primary">
      ...
      @if(App::environment()=='production')
       <form role="form" method="POST" action="{{secure_asset('tampil_pen_luaran_hki/update_pen_luaran_hki')}}" enctype="multipart/form-data">
        @else
        <form role="form" method="POST" action="{{url('tampil_pen_luaran_hki/update_pen_luaran_hki/')}}" enctype="multipart/form-data">
          @endif
          {{csrf_field()}}
