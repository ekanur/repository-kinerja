  ...
  <div class="row">
   <div class="col-md-10 col-md-offset-1">
    ...
    <div class="box box-primary">
      ...
      <form role="form" method="POST" action="{{secure_asset('tampil_peng_luaran_pemakalah/update_peng_luaran_pemakalah')}}" enctype="multipart/form-data">
        @else
        <form role="form" method="POST" action="{{url('tampil_peng_luaran_pemakalah/update_peng_luaran_pemakalah/')}}" enctype="multipart/form-data">
          @endif
          {{csrf_field()}}
