    ...
    <div class="col-md-10 col-md-offset-1">
      ...
      <div class="box box-primary">
       ...
       @if(App::environment()=='production')
        <form role="form" method="POST" action="{{secure_asset($menu['kategori'].'/tambah_pen_luaran_pemakalah/'.$menu['data']->id)}}" enctype="multipart/form-data">
          @else
          <form role="form" method="POST" action="{{url($menu['kategori'].'/tambah_pen_luaran_pemakalah/'.$menu['data']->id)}}" enctype="multipart/form-data">
            @endif
            {{csrf_field()}}
