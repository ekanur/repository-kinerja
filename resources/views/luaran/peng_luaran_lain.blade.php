   ...
   <div class="col-md-12">
     ...
     <div class="box">
      <div class="box-header">
        <h3 class="box-title">Data Pengabdian - Luaran Lain </h3>
      </div>
      <div class="box-body">
      ...
      <tbody>
        ...
        <tr>
          ...
          @if(Session::get('userRole')!='Dosen')
  <td>
    <a class="btn btn-sm btn-info  fa fa-edit" href="tampil_peng_luaran_lain/edit_peng_luaran_lain/{{$tampil->id}}" title="Edit Luaran"></a>
  </td>

<td>
  <a class="btn btn-sm btn-danger fa fa-trash" onclick="return confirm('Anda Yakin Ingin Menghapus Data ?')" href="tampil_peng_luaran_lain/hapus_lain_peng/{{$tampil->id}}" title="Hapus Luaran"></a>
</td>
@endif
...
<div class="box-footer clearfix">
  @if(Session::get('userRole')!='Dosen')
  <a href="{{url('tampil_peng_luaran_lain/tambah_non_peng_luaran_lain')}}" class="btn btn-md btn-success btn-flat pull-left glyphicon glyphicon-new-window"  style="margin-right:10px" title="Tambahkan Luaran Tanpa Pengabdian"></a>
  @endif
</div>
</div>
