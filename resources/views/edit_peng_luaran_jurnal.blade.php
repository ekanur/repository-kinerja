   ...
   <div class="col-md-10 col-md-offset-1">
    ...
    <div class="box box-primary">
      ...
      @if(App::environment()=='production')
       <form role="form" method="POST" action="{{secure_asset('tampil_peng_luaran_jurnal/update_peng_luaran_jurnal')}}" enctype="multipart/form-data">
        @else
        <form role="form" method="POST" action="{{url('tampil_peng_luaran_jurnal/update_peng_luaran_jurnal/')}}" enctype="multipart/form-data">
          @endif
          {{csrf_field()}}
