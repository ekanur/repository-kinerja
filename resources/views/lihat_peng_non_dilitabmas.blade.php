          ...
          <div class="row">
             ...
             @endif
              <div class="box box-primary">
                ...
                <form role="form" method="POST" action="{{secure_asset($menu['kategori'].'/update_peng_non_dilitabmas/'.$menu['data']->id)}}" enctype="multipart/form-data">
                @else
                    <form role="form" method="POST" action="{{url($menu['kategori'].'/update_peng_non_dilitabmas/'.$menu['data']->id)}}" enctype="multipart/form-data">
                  @endif
                {{csrf_field()}}
        ...
        <input type="hidden" id="kategori" value="{{$menu['kategori']}}">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="anggota_3" name="anggota_3" placeholder="Kosongkan Jika Tidak Ada" value="{{$menu['data']->anggota_3}}" readonly="">
            </div>

            <div class="form-group">
              <label for="anggota_4">Anggota 4</label>
              <input type="text" class="form-control" id="anggota_4" name="anggota_4" placeholder="Kosongkan Jika Tidak Ada" value="{{$menu['data']->anggota_4}}" readonly="">
            </div> 


            <div class="form-group">
              <label for="anggota_5">Anggota 5</label>
              <input type="text" class="form-control" id="anggota_5" name="anggota_5" placeholder="Kosongkan Jika Tidak Ada" value="{{$menu['data']->anggota_5}}" readonly="">
            </div>

 <div class="form-group col-md-6" style="padding-left: 0px;padding-right: 5px">
             <label for="skema_peng">Skema</label>
            <input type="text" class="form-control" id="Skema" name="Skema" value="{{$menu['data']->skema}}" readonly="">
           </div>
 ...
 <div class="form-group col-md-6" style="padding-right: 0px;padding-left: 10px">
     ...
     <div class="form-group col-md-4" style="padding-left: 0px;padding-right: 10px">
      ...
      <input type="text" class="form-control" id="jumlah_alumni" name="jumlah_alumni" placeholder="jumlah_alumni" value="{{$menu['data']->jumlah_alumni}}"readonly="" >
       ...
       <div class="form-group col-md-4" style="padding-right: 0px;padding-left:0px">
      <label for="jumlah_staf">Jumlah Staf Pendukung</label>
      <input type="text" class="form-control" id="jumlah_staf" readonly="" name="jumlah_staf" placeholder="Jumlah Staf" value="{{$menu['data']->jumlah_staf}}">
    </div>
      ...
      <input type="text" class="form-control" id="tahun_mulai" name="tahun_mulai" placeholder="Tahun Mulai " value="{{$menu['data']->tahun_mulai}}" readonly="">
    </div>

           <div class="form-group col-md-3" style="padding-left: 0px;padding-right: 0px">
      <label for="tahun_selesai">tahun selesai</label>
      <input type="text" class="form-control" id="tahun_mulai" name="tahun_selesai" placeholder="Tahun Selesai" value="{{$menu['data']->tahun_selesai}}" readonly="">
    </div>
     ...
     <div class="form-group col-md-4" style="padding-left: 0px;padding-right: 10px">
      ...
      <input type="text" class="form-control" id="tahun_ke" readonly="" name="tahun_ke" placeholder="Tahun Ke" value="{{$menu['data']->tahun_ke}}">
    </div>

     <div class="form-group col-md-8" style="padding-left: 0px;padding-right: 10px">
      <label for="sumber_dana">Sumber Dana</label>
      <input type="text" class="form-control" id="sumber_dana" readonly="" name="sumber_dana" placeholder="Sumber Dana kegiatan" value="{{$menu['data']->sumber_dana}}">
    </div>
