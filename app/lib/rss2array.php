...
*******************************************************************************/
 ...
 #
    ...
    function rss2array($url){
		...
		unset($rss2array_globals[channel_pubDate]);
		unset($rss2array_globals[channel_dateother]);
		...
		unset($rss2array_globals[current_category]);
		unset($rss2array_globals[current_dateother]);
		unset($rss2array_globals[current_creator]);
		unset($rss2array_globals[current_content]);
		unset($rss2array_globals[current_guid]);
		unset($rss2array_globals[current_source]);
    ...
    function startElement($parser, $name, $attrs){
        ...
        elseif($name == "CHANNEL"){
			...
			$rss2array_globals[channel_pubDate] = "";
			$rss2array_globals[channel_dateother] = "";
    ...
    function characterData($parser, $data){
        ...
        if($rss2array_globals[inside_item]){
            ...
            switch($rss2array_globals[current_tag]){
                ...
                break;
				case "CATEGORY":
                $rss2array_globals[current_category] .= $data;
                break;
				case "DC:DATE":
                $rss2array_globals[current_dateother] .= $data;
                break;
				case "DC:CREATOR":
                $rss2array_globals[current_creator] .= $data;
                break;
				case "CONTENT:ENCODED":
                $rss2array_globals[current_content] .= $data;
                break;
				case "GUID":
                $rss2array_globals[current_guid] .= $data;
                break;
				case "DC:SOURCE":
                $rss2array_globals[current_source] .= $data;
                break;
        ...
        elseif($rss2array_globals[inside_channel]){
            ...
            switch($rss2array_globals[current_tag]){
                ...
                break;
				case "PUBDATE":
                $rss2array_globals[channel_pubDate] .= $data;
                break;
				case "DC:DATE":
                $rss2array_globals[channel_dateother] .= $data;
                break;
    ...
    function endElement($parser, $name){
        ...
        if($name == "ITEM"){
            ...
            $rss2array_globals[items][] = array(title => trim($rss2array_globals[current_title]), link => trim($rss2array_globals[current_link]), description => trim($rss2array_globals[current_description]), pubDate => trim($rss2array_globals[current_pubDate]), category => trim($rss2array_globals[current_category]), dateother => trim($rss2array_globals[current_dateother]), creator => trim($rss2array_globals[current_creator]), content => trim($rss2array_globals[current_content]), guid => trim($rss2array_globals[current_guid]), source => trim($rss2array_globals[current_source]));
			...
			$rss2array_globals[current_category] = "";
			$rss2array_globals[current_dateother] = "";
			$rss2array_globals[current_creator] = "";
			$rss2array_globals[current_content] = "";
			$rss2array_globals[current_guid] = "";
			$rss2array_globals[current_source] = "";
        ...
        elseif($name == "CHANNEL"){
			...
			$rss2array_globals[channel][pubDate] = trim($rss2array_globals[channel_pubDate]);
			$rss2array_globals[channel][dateother] = trim($rss2array_globals[channel_dateother]);
